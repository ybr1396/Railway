...
import java.util.*;
public class TicketBooking {// 63 berths(upper ,lower , middle) + ( 18 RAC passengers)
...
// book ticket
	public <passengers> void bookTicket(Passenger p, int berthInfo, String allotedBerth) {
